...
<div class="content">
    <div id="jquery-accordion-menu" class="jquery-accordion-menu red">
        ...
        <ul id="demo-list">
            ...
            <li class="active"><a href="#" onclick="document.getElementById('contentFrame').src='admin-info.jsp';return false;"><i class="fa fa-user"></i>查看个人信息</a></li>
            <li><a href="#" onclick="document.getElementById('contentFrame').src='admin-impEmp.jsp';return false;"><i class="fa fa-arrow-up"></i>导入员工绩效</a></li>
            <li><a href="#" onclick="document.getElementById('contentFrame').src='admin-impChief.jsp';return false;"><i class="fa fa-arrow-up"></i>导入主管信息</a></li>
...
<%--默认定向--%>
<script>document.getElementById('contentFrame').src='admin-info.jsp';</script>
