...
<div class="content">
    <div id="jquery-accordion-menu" class="jquery-accordion-menu red">
        ...
        <ul id="demo-list">
            ...
            <li class="active"><a href="#" onclick="document.getElementById('contentFrame').src='emp-info.jsp';return false;"><i class="fa fa-user"></i>查看个人信息</a></li>
            <li><a href="#" onclick="document.getElementById('contentFrame').src='emp-viewPerformance.jsp';return false;"><i class="fa fa-calendar"></i>查看我的绩效</a></li>
            <li><a href="#" onclick="document.getElementById('contentFrame').src='emp-changePwd.jsp';return false;"><i class="fa fa-exchange"></i>修改密码</a></li>
...
<%--默认定向--%>
<script>document.getElementById('contentFrame').src='emp-info.jsp';</script>
